...
class peminjaman extends Model
{
    ...
    protected $fillable = [
        'id', 'ID_Peminjam', 'Tujuan', 'Lokasi_Penjemputan', 'Tanggal_Peminjaman', 'Waktu_Peminjaman', 'Tanggal_Pengembalian', 'Waktu_Pengembalian', 'Bukti_Peminjaman', 'created_at', 'updated_at', 'Status'
    ];
}
