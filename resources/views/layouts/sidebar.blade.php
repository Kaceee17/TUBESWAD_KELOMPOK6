...
<div class="container-fluid">
    ...
    <div class="col-md-2 sidebar p-0">
            ...
            <table class="nav flex-column">
                <!-- Sidebar Links -->
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="Dashboard.php">Peminjaman</a></td>
                </tr>
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="Peminjaman.php">Master Kendaraan</a></td>
                </tr>
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="{{ route('manageinstansi.index') }}">Management Instansi</a></td>
                </tr>
                <tr class="nav-item">
                    <td><Management class="nav-link active option" href="Master Setup.php">Management User</a></td>
                </tr>
                <tr class="nav-item">
                    <td><Pembayaran class="nav-link active option" href="Rekapitulasi.php">Pembayaran</a></td>
                </tr>
            </table>
        </div>
    <!-- Navbar Internal -->
    ...
    <ul class="navbar-nav">
        <div class="navbar-nav justify-content-between w-100" >
                <div class="d-flex" >
                <a class="nav-link" href="{{ route('manageinstansi.create') }}" style = "color: black; margin-top: 10px;">Add</a>
                <a class="nav-link" href="{{ route('manageinstansi.index') }}" style = "color: black; margin-top: 10px;">List</a>
                </div>
            </div>
        <li class="nav-item dropdown no-arrow">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="logoutDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="{{ asset('img/logout.png') }}" alt="Logout" height="40"> <!-- Adjust the path to your logout icon -->
            </a>

            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="logoutDropdown">
                <a class="dropdown-item" href="{{ route('manageinstansi.index') }}"
                   onclick="event.preventDefault();
                   document.getElementById('logout-form').submit();">
                    {{ __('Logout') }}
                </a>
                <form id="logout-form" action="{{ route('manageinstansi.index') }}" method="POST" class="d-none">
                    @csrf
                </form>
            </div>
        </li>
