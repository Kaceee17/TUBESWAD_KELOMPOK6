    ...
    <section class="relative flex flex-wrap lg:h-screen lg:items-center">
      <div class="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
        <div class="mx-auto max-w-lg text-center">
          <h1 class="text-2xl font-bold sm:text-3xl">Login to T-Fleet</h1>
        </div>
        ...
        <form action="" class="mx-auto mb-0 mt-8 max-w-md space-y-4">
          ...
          <div class="flex items-center justify-between">
            ...
            <a href="dashboard.php" type="submit" class="inline-block rounded-lg bg-red-500 px-5 py-3 text-sm font-medium text-white">Sign in</a>
          </div>
        </form>
      </div>

      <div class="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2">
        <img alt="Welcome" src="gedung.jpg" class="absolute inset-0 h-full w-full object-cover" />
      </div>
    </section>
  </body>
</html>
