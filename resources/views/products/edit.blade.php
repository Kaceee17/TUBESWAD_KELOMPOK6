...
<section id='form'>
    <div class="container">
        ...
        <form action="{{ route('products.edit', ['id' => $peminjaman->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card">
                        ...
                        <div class="col-auto">
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="col-0.5"><label>:</label></div>
                                    <div class="col-9"><input type="text" class="form-control" name="nama_peminjam" value="{{ $peminjam->Nama }}"></div>
                                </div>
                                <div class="input-group">
                                    <div class="col-2"><label for="nip/nim">NIP / NIM</label></div>
                                    <div class="col-0.5"><label>:</label></div>
                                    <div class="col-9"><input type="text" class="form-control" name="nip/nim" value="{{ $peminjam->NIP_NIM }}"></div>
                                </div>
                                <div class="input-group">
                                    <div class="col-2"><label for="no_hp">No. Hp</label></div>
                                    <div class="col-0.5"><label>:</label></div>
                                    <div class="col-9"><input type="text" class="form-control" name="no_hp" value="{{ $peminjam->No_Hp }}"></div>
                                </div>
                                <div class="input-group">
                                    <div class="col-2"><label for="email">Email</label></div>
                                    <div class="col-0.5"><label>:</label></div>
                                    <div class="col-9"><input type="email" class="form-control" name="email" value="{{ $peminjam->Email }}"></div>
                                </div>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2">
                                    <div class="mb-2">
                                        ...
                                        <div class="mb-2">
                                            <a class="btn btn-secondary btn-block" href="{{ route('products.closeupdatepeminjaman', ['id' => $peminjaman->id]) }}" role="button">Close</a>
                                        </div>
                                        @else
                                        <div class="mb-2">
                                            <a class="btn btn-success btn-block" href="{{ route('products.edit.approve', ['id' => $peminjaman->id]) }}" role="button">Approve</a>
                                        </div>
                                        <div class="mb-2">
                                            <a class="btn btn-danger btn-block" href="{{ route('products.edit.reject', ['id' => $peminjaman->id]) }}" role="button">Reject</a>
                                        </div>
                                        <div class="mb-2">
                                            <a class="btn btn-dark btn-block" href="{{ route('products.destroyAll', ['id' => $peminjaman->id]) }}" role="button">Delete</a>
                                        </div>
                                        <div class="mb-2">
                                            <a class="btn btn-secondary btn-block" href="{{ route('products.closeupdatepeminjaman', ['id' => $peminjaman->id]) }}" role="button">Close</a>
                                        </div>
