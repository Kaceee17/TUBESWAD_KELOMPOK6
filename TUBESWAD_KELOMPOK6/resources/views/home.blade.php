...
<div class="row justify-content-center mt-3">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('kendaraans.create') }}" class="btn btn-success btn-sm mb-3"><i class="bi bi-plus-circle"></i> Tambah Kendaraan Baru</a>
                <table class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th scope="col" style="text-align: center;">#</th>
                        <th scope="col" style="text-align: center;">Nama Instansi</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; line-height: 2;">{{ $kendaraan->nama_instansi }}</td>
