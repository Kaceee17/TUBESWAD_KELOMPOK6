...
<div class="container-fluid">
    ...
    <div class="col-md-2 sidebar p-0">
            ...
            <table class="nav flex-column">
                <!-- Sidebar Links -->
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="Peminjaman.php">Peminjaman</a></td>
                </tr>
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="{{ route('kendaraans.index') }}">Master Kendaraan</a></td>
                </tr>
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="Master Setup.php">Management Instansi</a></td>
                </tr>
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="Rekapitulasi.php">Management User</a></td>
                </tr>
                <tr class="nav-item">
                    <td><a class="nav-link active option" href="Laporan.php">Pembayaran</a></td>
                </tr>
            </table>
        </div>
    <!-- Navbar Internal -->
